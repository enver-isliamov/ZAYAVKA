...
const googleSheetsWebAppURL = 'https://script.google.com/macros/s/AKfycbw3NlTDbPq3bZ7R2FAXcTOwpn7ZALbI-5cSqPLr6vt713CbZvMpP8EWjmQODHEZDM8JEA/exec'; 
...
function sendToGoogleSheets(data) {
    ...
    if (!googleSheetsWebAppURL || googleSheetsWebAppURL === 'https://script.google.com/macros/s/AKfycbw3NlTDbPq3bZ7R2FAXcTOwpn7ZALbI-5cSqPLr6vt713CbZvMpP8EWjmQODHEZDM8JEA/exec') {
...
window.onload = () => {
    ...
    if(sendButton){
        sendButton.addEventListener('click', processFormSubmission); 
    }
};
