...
const googleSheetsWebAppURL = 'https://script.google.com/macros/s/AKfycbz-_ro4L5M9teLjYn3_Rid866MD0QkdYBW7wT3YIXXvFqHIEU2KEgYiD0zqBXTp4wXoUQ/exec'; // <--- УБЕДИТЕСЬ, ЧТО ЭТОТ URL ПРАВИЛЬНЫЙ И ВСТАВЛЕН!
...
function sendToGoogleSheets(data) {
    ...
    if (!googleSheetsWebAppURL || googleSheetsWebAppURL === 'ВСТАВЬТЕ_СЮДА_URL_ИЗ_GOOGLE_APPS_SCR// --- КОНСТАНТЫ ПРОЕКТА ---
// Токен @KopchekBot Telegram бота. В реальных проектах это должно храниться на сервере, а не в клиенте.
const telegramBotToken = "7134836219:AAFOKRDl_f7_nft2Q52UxXFx244Gpqs7DPs"; 
// ID чата Telegram, куда будут отправляться сообщения.
const chatId = "96609347";
